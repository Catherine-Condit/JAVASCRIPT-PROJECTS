//for easy reference, the game's robot and alien symbols are called "x" and "o", respectively, throughout the code.
//This variable keeps track of whose turn it is.
let activePlayer = 'X';
//This array stores an array of move. We use this to determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the robot.gif is placed in HTML
            select.style.backgroundImage = 'url("symbols/robot.gif")';
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'
        } else {
            //If activePlayer is equal to 'O', the alien.gif is placed in HTML
            select.style.backgroundImage = 'url("symbols/alien.gif")';
        }
        ...
        audio('./media/choice.mp3');
        //This condition checks to see if it is the computers turn.
        if (activePlayer === 'O') {
            //Thus function disables clicking for computers turn.
            disableClick();
...
function checkWinConditions() {
    ...
    //This condition checks for a tie. If none of the above conditions are met and 9 squares are selected, the code executes.
        ...
        audio('./media/tie.wav');
        console.log("Tie game reached, resetting...")
...
//This function temporarily makes our body element unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This function clears our canvas after our win line in drawn.
    function clear() {
    ...
    animateLineDrawing();
    //This line waits 1 seconds. Then, clears canvas, resets game, and allows clicking again.
